  ...
  return (
    <div>
        ...
        <Col  className='d-flex flex-column align-items-center justify-content-center mt-5'>
            ...
            <Button onClick={()=>setRandomId(Math.floor(Math.random() * (30 - 1 + 1)) + 1)} variant="success" style={{borderRadius:'10px',padding:'10px',backgroundColor:'blue',color:'white',fontWeight:'bolder'}}>Get New User</Button>
        </Col>
